...
> 开工。更新于 2026-07-07（**v0.5.0 已发布**；差距清单三大项 + UX 四批 +
> debug 清扫完成；**全部已推送，origin == 本地**；若要出 v0.5.1 等用户说
> "发布"）。

## 当前状态（已完成，勿重做）

- **v0.5.0 tag 之后的提交（2026-07-07 已 push 到 origin/main）**：
...
- 待做候选（未开工）：暂无——三个候选全部落地；后续以真机验收反馈驱动。
