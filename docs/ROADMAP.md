...
> 开工。更新于 2026-07-09（**v0.6.0 已发布** + 其后**反馈批次 #1 本地 4
> 提交未发布**：反推紫天空根治 `7b6a64c`、去雾引擎 `66062be`、可靠性双修
> `9b60a62`、节流+打磨+速查 `24ed6a3`——见「当前状态」首条；反馈驱动阶段
> ——用户试用 → 报障/提需 → 修复/打磨 → 发布）。

## 当前状态（已完成，勿重做）

- **反馈批次 #1（2026-07-09，v0.6.0 后本地 4 提交，未发布）**——用户真机报障
